...
const ControlCenter = () => {
  ...
  return (
    <DefaultLayout componentName={pageName}>
      ...
      {location.pathname === MT5Menu[1].path ? <CoverageServersDataTable /> : <></>}
      {location.pathname === MT5Menu[2].path ? <ManagersDataTable /> : <></>}
      {location.pathname === MT5Menu[3].path ? <PermissionsDataTable /> : <></>}
      {location.pathname === MT5Menu[4].path ? <RolesDataTable /> : <></>}
      {location.pathname === MT5Menu[5].path ? <TypesDataTable /> : <></>}
